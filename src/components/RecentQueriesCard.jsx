  ...
  return (
    <div className="card bg-base-100 shadow-md p-4 border rounded-md">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-sm mb-1">
          <strong>Query-Name: </strong> {queryTitle}
        </p>
        ...
        <Link to={`/query/${_id}`} className="w-full text-center bg-[#ff7361] py-2 hover:bg-[#2f3239] hover:text-white transition-all rounded-md">
          See More
        </Link>
      </div>
    </div>
